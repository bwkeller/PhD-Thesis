...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    \begin{abstract}
        ...
        \setcounter{page}{3}\thispagestyle{plain}
            In this thesis, we have explored how supernovae, when modeled with a
            robust, physically-motivated method, can impact the growth and
            evolution of galaxies.  This model is based on the previously
            ignored physics of thermal conduction, and is robust in the face of
            varying resolution and unresolved ISM and magnetic field structure.
            I show that it results in effective star formation regulation and
            highly mass loaded galactic winds in simulations of isolated Milky
            Way and dwarf galaxies.  We use this new model to study the
            evolution of Milky Way like galaxies, showing three critical
            results.  First, outflows at high redshift are key to regulating the
            formation of stars and the growth of spheroidal bulges.  Second, as
            ...
            for feedback from supermassive black holes.  All of this arises due
            to fundamental features of supernovae-driven outflows.  These
            outflows produce mass loadings that are large ($\eta\sim 10$) at
            high redshift, allowing the galaxy to expel much of its star forming
            gas, and the majority of the gas that would have formed a stellar
            bulge.  However, because these outflows become less efficient in
            higher mass galaxies, they become unable to eject significant
            amounts of gas once the escape velocity of the galactic disk exceeds
            $\sim 250\;\rm{km/s}$, resulting in the runaway growth of stars and
            the formation of a massive stellar bulge.  This runaway bulge growth
            is predicated on the transport of large amounts of gas mass to the
            central $\sim kpc$ of the galaxy, transport that would likely
            increase the accretion rate of the central supermassive black hole,
            potentially triggering an active galactic nucleus.  Finally, I use
            the simulations I have generated to show how $\Lambda CDM$ is
            consistend with recently observed galaxy kinematics.  This
            demonstrates that the relation between baryonic accelerations and
            the accelerations due to dark matter requires no physics beyond
            standard dissipational collapse in a $\Lambda CDM$ universe.  This
            thesis helps to solidify our understanding of the essential role
            that supernovae play in galaxy formation: regulating star
            formation, preventing runaway bulge growth, and setting the peak of
