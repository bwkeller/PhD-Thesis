...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    \begin{abstract}
        ...
        \setcounter{page}{3}\thispagestyle{plain}
            ...
            I show that it produces more effective star formation regulation and
            more mass loaded galactic winds in simulations of isolated Milky Way
            and dwarf galaxies.  I then use that new model to study the
            evolution of Milky Way like galaxies, showing three critical
            results.  First, I show that outflows at high redshift are key to
            regulating the formation of stars and the growth of spheroidal
            bulges.  Second, I show that as galaxies grow beyond a halo mass of
            $10^{12}\Msun$, supernovae alone are unable to prevent runaway star
            formation, pointing to the need for feedback from supermassive black
            holes.  All of this arises due to fundamental features of
            supernovae-driven outflows.  These outflows produce mass loadings
            that are large $\eta\sim 10$ at high redshift, allowing the galaxy
            to expel much of its star forming gas, and the majority of the gas
            that would have formed a stellar bulge.  However, because these
            outflows become less efficient in higher mass galaxies, they become
            unable to eject significant amounts of gas once the escape velocity
            of the galactic disk exceeds $\sim 250\;\rm{km/s}$, resulting in the
            runaway growth of stars and the formation of a massive stellar
            bulge.  This runaway bulge growth is predicated on the transport of
            large amounts of gas mass to the central $\sim kpc$ of the galaxy,
            transport that would likely increase the accretion rate of the
            central supermassive black hole, potentially triggering an active
            galactic nucleus.  Finally, I use the simulations I have generated
            to show how $\Lambda CDM$ is consistend with the recently observed
            radial acceleration relation.  This demonstrates that the shape and
            scatter of the relation requires no physics beyond standard
            dissipational collapse in a $\Lambda CDM$ universe.  This thesis
            helps to solidify our understanding of the essential role that
            supernova feedback plays galaxy formation: regulating star
