...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
    \begin{abstract}
        ...
        \setcounter{page}{3}\thispagestyle{plain}
            In this thesis, I present a new model for feedback from supernovae.
            ...
            potentially triggering an active galactic nucleus.  Finally, I will
            use the simulations I have generated to show how $\Lambda CDM$ can
            produce the detailed kinematics and resolved baryon ratios seen in
            observed galaxies, regardless of details in feedback or star
            formation.  This result suggests that the tight observed scatter is
            simply a result of dissipational collapse in galaxy formation,
            rather than evidence for exotic new physics.
    \end{abstract}
