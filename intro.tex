...
the functional form for the observed galaxy luminosity function
\citet{Schechter1976}:
\begin{equation}
    \frac{dn}{dM}(M,t) =
...
with volumes $\gtrsim 10^6;\rm{Mpc^3}$, but with spatial resolutions $\sim \rm{kpc}$
...
is a power law of the gas density: $\dot\Sigma*\propto\Sigma_{gas}^\alpha$, with
...
$\sim35\%$ of the total feedback luminosity is lost too cooling of the swept-up
